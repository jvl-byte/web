...
const translations = {
  es: {
    ...
    playlistDesc: "Siempre actualizada.",
    playlistBtn: "Escuchar playlist",
    gameLabel: "el juego",
  ...
  en: {
    ...
    playlistDesc: "Always updated.",
    playlistBtn: "Listen to playlist",
    gameLabel: "the game",
  ...
  pt: {
    ...
    playlistDesc: "Sempre atualizada.",
    playlistBtn: "Ouvir playlist",
    gameLabel: "o jogo",
